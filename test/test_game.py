...
from src.game import find_all_positoins_in_word
from src.game import step_of_game
from src.game import change_letters_in_positions
...
class TestGame(unittest.TestCase):
    ...
    def test_list_init(self):
        ...
        """
        self.assertEqual(find_all_positoins_in_word("aaaa", 'a'), [0, 1, 2, 3])
        self.assertEqual(find_all_positoins_in_word('', 'b'), [])
    ...
    def test_change_letters_in_positions(self):
        ...
        :return: changed word
        """
        self.assertEqual(change_letters_in_positions('aaa', [0, 1, 2], 'b'), 'bbb')
